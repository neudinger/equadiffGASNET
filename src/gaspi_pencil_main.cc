...
// #define COLUMN_MAJOR_IDX(i, j) ((j) * (nbr_of_row)) + (i)
    ...
    if (iProc == 0)
    {
        ...
        for (gaspi_rank_t rank = 1; rank < nProc; rank++)
            SUCCESS_OR_DIE(gaspi_passive_send(
                /*const gaspi_segment_id_t segment_id_local: */ SEGMENT_ID::ID_PARAMS,
                /*const gaspi_offset_t offset_local: */ 0,
                /*const gaspi_rank_t rank: */ rank,
                /*const gaspi_size_t size: */ 5 * sizeof(std::size_t),
                /*const gaspi_timeout_t timeout_ms: */ GASPI_BLOCK));
    }
    else
    {
        ...
        SUCCESS_OR_DIE(gaspi_passive_receive(
            /*const gaspi_segment_id_t segment_id_local: */ SEGMENT_ID::ID_PARAMS,
            /*const gaspi_offset_t offset_local: */ 0,
            /*gaspi_rank_t *const rem_rank: */ &sender,
            /*const gaspi_size_t size: */ 5 * sizeof(size_t),
            /*const gaspi_timeout_t timeout_ms: */ GASPI_BLOCK));
    }
...
#define ENERGY_INIT args[PARAMS_ARGS::ARG_ENERGY_INIT]
    ...
    const gaspi_size_t segment_size = /*Local segment size*/ (nbr_of_col * nbr_of_row_local) +
    ...
    if (iProc == 0)
        ...
        stream_message_bench << __LINE__ << ','
                             ...
                             << std::flush;
#endif
    // printf("rank iProc: %d segment_size: %ld \n", iProc, segment_size);
    ...
    for (size_t nb = 0; nb < NBR_ITERS; nb++)
    {
        ...
        {
            // Get NORTH
            SUCCESS_OR_DIE(gaspi_read(/*const gaspi_segment_id_t segment_id_local: */ segment_id,
                                      /*const gaspi_offset_t offset_local: */ 0,
                                      /*const gaspi_rank_t rank: */ UP(iProc, nProc),
                                      /*const gaspi_segment_id_t segment_id_remote: */ segment_id,
                                      /*const gaspi_offset_t offset_remote: */ offset_array_north * sizeof(double),
                                      /*const gaspi_size_t size: */ nbr_of_col * sizeof(double),
                                      /*const gaspi_queue_id_t queue: */ queue_id,
                                      /*const gaspi_timeout_t timeout_m: */ GASPI_BLOCK));
        }
        if (DOWN(iProc, nProc) > 0)
        {
            // Get SOUTH
            SUCCESS_OR_DIE(gaspi_read(/*const gaspi_segment_id_t segment_id_local: */ segment_id,
                                      /*const gaspi_offset_t offset_local: */ offset_array_south * sizeof(double),
                                      /*const gaspi_rank_t rank: */ DOWN(iProc, nProc),
                                      /*const gaspi_segment_id_t segment_id_remote: */ segment_id,
                                      /*const gaspi_offset_t offset_remote: */ nbr_of_col * sizeof(double),
                                      /*const gaspi_size_t size: */ nbr_of_col * sizeof(double),
                                      /*const gaspi_queue_id_t queue: */ queue_id,
                                      /*const gaspi_timeout_t timeout_m: */ GASPI_BLOCK));
        }
        ...
        /* ---------------------- COMPUTE ---------------------- */
        // /* IN_PART */
        // compute_vectorized_I(/* double in_host = */ array,
        //                      /* double out_host = */ array_tmp,
        ...
        // /* EAST_PART */
        // compute_vectorized_E(/* double in_host = */ array,
        //                      /* double out_host = */ array_tmp,
        //                      nbr_of_col, nbr_of_row_local,
        //                      col_block_size, row_block_size,
        //                      col_block, row_block,
        ...
        // /* WEST_PART */
        // compute_vectorized_W(/* double in_host = */ array,
        //                      /* double out_host = */ array_tmp,
        //                      nbr_of_col, nbr_of_row_local,
        //                      col_block_size, row_block_size,
        //                      col_block, row_block,
        ...
        //                      /* std::initializer_list<size_t> row_idx_slice_idx = */
        //                      {row_block_size, row_block_size * (row_block - 1)});
        /* GASPI Recovery should be done */
        /* ---------------------- SYNC ---------------------- */
        SUCCESS_OR_DIE(gaspi_wait(queue_id, GASPI_BLOCK));
        /* ---------------------- END SYNC ---------------------- */
        // /* NORTH_PART */
        // compute_vectorized_N(/* double in_host = */ array,
        //                      /* double out_host = */ array_tmp,
        //                      nbr_of_col, nbr_of_row_local,
        //                      col_block_size, row_block_size,
        //                      col_block, row_block,
        ...
        // /* SOUTH_PART */
        // compute_vectorized_S(/* double in_host = */ array,
        //                      /* double out_host = */ array_tmp,
        //                      nbr_of_col, nbr_of_row_local,
        //                      col_block_size, row_block_size,
        //                      col_block, row_block,
